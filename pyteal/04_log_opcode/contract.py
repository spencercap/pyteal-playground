...
def approval():
    ...
    return Cond(
        ...
        [Txn.application_args[0] == Bytes("log_arg"), Seq([ Log( Txn.application_args[1] ), Approve() ])],
        [Txn.application_args[0] == Bytes("log_mult"), Seq([ Log( Txn.sender() ), Log( Txn.application_args[1] ), Approve() ])],

        # 85264719
        # 85281427
        # jelly vacant ready ghost eager spider assume used add deliver stage ring away verify rude betray decline occur gun match face various evolve absent bamboo
